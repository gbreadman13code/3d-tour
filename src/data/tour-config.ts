...
export const locationGroups: LocationGroup[] = [
  {
    ...
    map: {
          ...
          horizontal: false,
          markers: [
            { nodeId: 'yard-1', x: 50, y: 31, rotationOffset: -2.2 },
            { nodeId: 'yard-2', x: 55, y: 28, rotationOffset: -0.8 },
            ...
            { nodeId: 'yard-9', x: 45, y: 45, rotationOffset: -1.8 },
            // { nodeId: 'yard-10', x: 44, y: 41, rotationOffset: 3 },
            // { nodeId: 'yard-11', x: 44, y: 37, rotationOffset: -2 },
          ],
        },
    scenes: [
      {
...
defaultYaw: '0.0154rad', defaultPitch: '0.0479rad',
      ...
      // },
      {
        ...
        defaultYaw: '6.2148rad', defaultPitch: '0.0455rad',
        links: [
          { nodeId: 'yard-1', position: { yaw: 4.3584, pitch: 0.0428 } },
      ...
      //   defaultYaw: '6.2148rad', defaultPitch: '0.0455rad',
      //   links: [
      //     { nodeId: 'yard-9', position: { yaw: 1.8910, pitch: 0.0064 } },
